...
# Configuration
EPOCHS = 10
BATCH_SIZE = 4  # Further reduced for local GPU
LEARNING_RATE = 1e-4
MASK_PROB = 0.15
MAX_SEQ_LENGTH = 512
SLIDING_STEP = 256
...
class MassSpecDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mz_tensor = torch.tensor(mz_values, dtype=torch.float32)
        intensity_tensor = torch.tensor(intensity_values, dtype=torch.float32)
...
class MassSpecFormer(nn.Module):
    def __init__(self):
        ...
        config = BertConfig(hidden_size=256, num_attention_heads=8, num_hidden_layers=6)
...
if __name__ == "__main__":
    id_file = "./DRIAMS-D/id/2018/2018_clean.csv"
    spectra_dir = "./DRIAMS-D/preprocessed/2018/"
